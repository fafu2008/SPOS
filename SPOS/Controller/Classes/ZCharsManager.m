...
- (void)setDataSource:(id<ZCharsDataSource>)dataSource {
    ...
    [ZCharsStyle sharedManager].dataCount = [_dataSource collectionView:_rightView numberOfItemsInSection:0];
}
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    ...
    UICollectionReusableView *rightTitile = [[UICollectionReusableView alloc] initWithFrame:CGRectMake(0, 0, 50, 20)];
    UILabel *titile = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 50, 20)];
    titile.text = @"金额(CNY)";
    titile.textColor = [UIColor darkTextColor];
    [rightTitile addSubview:titile];
